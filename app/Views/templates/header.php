...
<html>
  <head>
    ...
    <?php if (isset($item['gName'])): ?>
      ...
      <meta property="twitter:image:src" content="<?= base_url() ?>/images/<?= $item['gImage'] ?>.jpeg">
    ...
    <?php elseif (isset($gametype)): ?>
      ...
      <meta property="twitter:image:src" content="<?= base_url() ?>/images/<?= $gametype[$number]['gImage'] ?>.jpeg">
    ...
    <?php else: ?>
      ...
      <?php endif; ?>
      <meta property="twitter:image:src" content="<?= base_url() ?>/images/<?=$founders[$number]['gImage']  ?>.jpeg">
