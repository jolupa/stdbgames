<div class="container">
  <section class="section">
    <div class="content">
      ...
      <h1>Who are You?</h1>
      <p>I'm <strong>jolupa</strong> a man of forty something always interested in technology, games, Linux and so on.</p>
      <p>Not new with the movement of news game pages or blogs: I was the webmaster of an incredible spanish fan site known as La Gran N dedicated to Nintendo (big fan of the Japan company).</p>
      ...
      <p>Sure here are the places where you can find me:</p>
      <ul>
        <li>Twitter: <strong>DbStadia</strong></li>
        <li>Mail: <strong>hello@stdb.games</strong></li>
      </ul>
