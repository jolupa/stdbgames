        ...
        <div class="column is-2">
          <div class="card is-shadowless">
            ...
            <div class="card-content">
              <p class="title is-5"><span class="icon-text"><span><?php if ( $reviews['urole'] == 1 ): ?>Our Staff<?php else: ?><?= $reviews['uname'] ?><?php endif; ?></span><?php if ( $reviews['urole'] == 1 ): ?>&nbsp;<span class="icon"><i class="fas fa-users"></i></span><?php endif; ?><?php if ( $reviews['urole'] == 2 ): ?>&nbsp;<span class="icon"><i class="far fa-newspaper"></i></span><?php endif; ?></span></p>
