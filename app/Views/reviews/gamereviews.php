      ...
      <div class="column">
        <div class="media is-shadowless">
          ...
          <div class="media-content">
            <p class="title is-5"><span class="icon-text"><span><?= $reviews['name'] ?>&nbsp;Review</span><?php if ( $reviews['role'] == 2 ): ?>&nbsp<span class="icon"><i class="far fa-newspaper"></i></span><?php endif; ?></span></p>
