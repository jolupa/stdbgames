...
<div class="content tab-content" id="table">
      ...
      <?php else: ?>
        <?php foreach($price as $price): ?>
          <tr>
            ...
            <td class="has-text-centered"><?php if($price['date_till_pro'] != ''): ?><?= date('d-m-Y', strtotime($price['date_till_pro'])) ?>&nbsp;<?php else: ?>--&nbsp;<?php endif; ?>/<?php if($price['date_till_nonpro'] != ''): ?>&nbsp;<?= date('d-m-Y', strtotime($price['date_till_nonpro'])) ?><?php else: ?>&nbsp;--<?php endif; ?></td>
          </tr>
        <?php endforeach; ?>
      <?php endif; ?>
    </tbody>
