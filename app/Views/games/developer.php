        ...
        <div class="card">
          <div class="card-content">
            <div class="content">
              ...
              <p class="subtitle is-5"><?php if (isset ($developer['0']['dWebsite'])): ?><span class="icon"><a href="<?= $developer['0']['dWebsite'] ?>"><i class="fas fa-sign-out-alt"></i></a></span><?php endif; ?> <?php if ( get_cookie($admin) != NULL): ?><span class="icon"><a href="<?= base_url() ?>/games/deveditform/<?= $developer['0']['dSlug'] ?>"><i class="far fa-edit"></i></a></span><?php endif; ?></p>
            </div>
          </div>
          <div class="card-content">
            <div class="columns">
              ...
              <div class="column is-one-quarter">
                <div class="media">
                  ...
                  <div class="media-content">
                    <p class="title is-5"><a href="<?= base_url() ?>/games/game/<?= $developer['dgSlug'] ?>"><?= character_limiter($developer['dgTitle'], 15, '...') ?></a></p>
