        ...
        <div class="card">
          <div class="card-content">
            <div class="content">
              ...
              <p class="subtitle is-5"><?php if (isset ($developer['0']['dWebsite'])): ?><span class="icon"><a href="<?= $developer['0']['dWebsite'] ?>"><i class="fas fa-sign-out-alt"></i></a></span><?php endif; ?> <span class="icon"><a href="<?= base_url() ?>/games/deveditform/<?= $developer['0']['dSlug'] ?>"><i class="far fa-edit"></i></a></p>
            </div>
          </div>
          <div class="card-content">
            <div class="columns">
