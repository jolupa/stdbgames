        ...
        <div class="card">
          <div class="card-content">
            <div class="content">
              ...
              <p class="subtitle is-5"><?php if (isset ($publisher['0']['pWebsite'])): ?><a href="<?= $publisher['0']['pWebsite'] ?>" target="_blank"><span class="icon"><i class="fas fa-sign-out-alt"></i></span></a><?php endif; ?> <?php if ( session('role') == 1 ): ?><a href="<?= base_url() ?>/games/pubeditform/<?= $publisher['0']['pSlug'] ?>"><span class="icon"><i class="far fa-edit"></i></span></a><?php endif; ?></p>
            </div>
          </div>
          <div class="card-content">
            <div class="columns">
