<div class="navbar-item has-dropdown is-hoverable">
  ...
  <div class="navbar-dropdown">
    ...
    <a class="navbar-item" href="<?= base_url ( '/games/coming' ) ?>"><strong><?= $waiting ?></strong>&nbsp;Games waiting launch</a>
    <a class="navbar-item" href="<?= base_url ( '/games/pro' ) ?>"><strong><?= $totalpro ?></strong>&nbsp;Pro games since launch</a>
    <a class="navbar-item" href="<?= base_url ( '/games/rumours' ) ?>"><strong><?= $rumors ?></strong>&nbsp;Rumoured games coming</a>
    <a class="navbar-item" href="<?= base_url ( '/games/nodate' ) ?>"><strong><?= $nodate ?></strong>&nbsp;Games with no date</a>
  </div>
</div>
