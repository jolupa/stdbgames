      ...
      <?php foreach ($updated as $updated): ?>
        <div class="column is-one-third-desktop is-half-mobile">
          <div class="card is-shadowless">
            ...
            <div class="card-content">
              <p class="title is-5"><span class="icon-text"><?php if ($updated['rumor'] == 1): ?><span class="icon has-text-color-coral"><i class="fas fa-exclamation"></i></span><?php endif; ?><span><a  href="<?= base_url('/games/'.$updated['slug']) ?>" title="<?= $updated['name'] ?>"><?= ellipsize($updated['name'], 15, 1, '...') ?></a></span></p>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
