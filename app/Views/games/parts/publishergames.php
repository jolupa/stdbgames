    ...
    <div class="column is-4-desktop is-one-third-mobile">
      <div class="card is-shadowless">
        ...
        <div class="card-content is-hidden-mobile">
          <p class="title is-5"><span class="icon-text"><?php if (  $published['rumor'] == 1 ): ?><span class="icon has-text-coral"><i class="fas fa-exclamation"></i></span><?php endif; ?><span><a href="<?= base_url ( '/game/'.$published['game_slug'] ) ?>"><?= ellipsize ( $published['game_name'], 15, 1, '...' ) ?></a></span></span></p>
